...
public void showLogo() {
    ...
    b4=box(logo(),fillColor("White"));
    render(vcat([b4], center(),grow(0.9),size(50,50)));

}

public void banner(str s){
  	b2 = box(text(s,fontSize(40),fontColor("Black"), font("Serif"),fontBold(true)),hshrink(1.0),vshrink(1.0),fillColor("yellow"),left(), right());
  	render(b2);
}
